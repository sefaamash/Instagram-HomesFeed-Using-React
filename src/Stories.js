...
const Stories = () => {
  const [state, setState] = React.useState([
    ...
    { id: 10, image: "/images/feroz1.jpg", name: "feroz432" },
    { id: 11, image: "/images/0.jfif", name: "adil5" },
    { id: 12, image: "/images/imrankhan1.jpg", name: "imran4" },
    { id: 13, image: "/images/imrankhan3.jpg", name: "khan4" },
    { id: 14, image: "/images/imrankhanpost.jpg", name: "alikhan4" },
  ]);
  return (
